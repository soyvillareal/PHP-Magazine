   ...
   (function(){
      ...
      $(document).scroll(function(){
         if(b && ($(document).scrollTop() + $(window).height()) >= q.height()){
            b = !1, n.removeClass('hidden'), $.post(paper_u.url.load_posts+"?token="+paper_u.token, {user_id: paper_u.user_id, profile_ids: JSON.stringify(l)}, function(e){
               if(e.S == 200) {
         ...
         var v = $(this);
         z(v), $.post(paper_u.url.follow+"?token="+paper_u.token, {user_id: paper_u.user_id}, function(e){
            console.log(e);
            if(e.S == 200) {
         ...
         $('.item_rinput:checked') && w(j, !1), x.text(''), y.val('').next().find('.text_email_count').text(0), d()
