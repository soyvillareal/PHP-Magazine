(function(){
    ...
    $('#show-symbols').click(function(){
        ...
        x.addClass('spinner-is-loading'), y(!0), $.post(paper_ar.url.reset_password+"?token="+paper_ar.token, {'password': v.val(), 're-password': o.val(), 'tokenu': paper_ar.tokenu}, function(e){
            e.S == 200 ? window.location.href = paper_ar.url.r_login : (r.text(e.E), s(v), s(o), x.removeClass('spinner-is-loading'), y(!1));
        })
