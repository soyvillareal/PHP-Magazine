  ...
  var f = function(e, u){
    ...
    (function(){
      $('#btn-post').click(function(e){
        ...
        }), t.append('thumb_sources', JSON.stringify(c)), t.append('post_id', paper.post_id), t.append('title', $('#title').val()), t.append('category', $('#category').val()), t.append('type', $('#type').val()), t.append('description', $('#description').val()), t.append('tags', $('#tags').val()), n.attr('contenteditable', !1), s(f(o, !0), d), f(y, !0).addClass('spinner-is-loading'), $.ajax({
          url: paper.url.edit_post+"?token="+paper.token,
          type: 'POST',
          data: t,
          contentType: false,
          processData: false,
      ...
      var o = paper.psources_count,
          z = paper.tsources_count,
          r = $('.btn_asource');
      r.click(function(){
        var w = $(this),
            h = w.attr('data-type'),
      ...
      $(document).on('click', '.btn_esource', function(){
        ...
        l && (s(!1, u, w), f(w, !0).addClass('spinner-is-loading'), $.post(paper.url.entry+"?token="+paper.token, {type: d.index(w)}, function(e){
                  if(e.S == 200) {
                    g(w), $('#entries').append(e.HT).find('.item_key').focus(), e.TP == 'text' && j(!0), e.TP == 'video' && $('#type').val('video'), f($('#btn-post'), !0)
                  } else k(!1, u, e.E, w);
                }))
      }), j()
    })()
