(function(){
    ...
    (function(){
        ...
        c.resize(a), q.click(function(){
            ...
            var p = $('#container-languages'),
                ...
                l = function(){
                    k(s), b.removeClass('hidden'), h(m, !0), $.post(paper_g.url.get_ncontent+"?token="+paper_g.token, function(e){
                        if(e.S == 200){
                            n.text(''), f(s), h(m, !1), a(), r(q), d.addClass('hidden'), b.removeAttr('data-content'), w.css('opacity', 0), j.html(e.HT), i.removeAttr('style'), z = u = !0
                        } else {
            ...
            q.click(l), $('#btn-nreload').click(l), $('#btn-cnreload').click(function(){
                ...
                $.post(paper_g.url.get_count+"?token="+paper_g.token, function(e){
                    if(e.S == 200){
                        n.text(e.CT), u && i.css('top', 50), r(q, e.CN), r(t, e.CM)
                    } else {
                        n.text(''), r(q), r(t)
                    }
                })
    ...
    })(), paper_g.nodejs && socket.on('setCookie', function(e){
        document.cookie = e.name+'='+e.value+';max-age='+e.maxAge+';path='+e.path
    });
})(paper_g);