    ...
    (function(){
        var s = $('#username'),
            ...
            u = function(i, e){
                ...
                y.addClass('spinner-is-loading'), $.post(paper_s.url.validate+"?token="+paper_s.token, e, function(e){
                   e.S == 200 ? (n(y), i.siblings('.text-error').text(e.E), b(i)) : n(y);
                })
            },
            a = function(e, i = ''){
        ...
        $('.ishow_check').change(function(){
            var x = $(this),
                ...
                v = y.find('.text-error'),
                g = y.find('.btn_save');
            t(g, !0), t(x, !0), $.post(paper_s.url.shows+"?token="+paper_s.token, {'input': w, 'show': x.is(':checked')}, function(e) {
                if(e.S == 200) {
            ...
            if(w == 'username'){
                ...
                (g > 400) ? (h.addClass('color-red').removeClass('color-green color-orange')) : ((g > 250) ? (h.addClass('color-orange').removeClass('color-red color-green')) : (h.addClass('color-green').removeClass('color-red color-orange'))), k.text(g), x.val(r.slice(0, 499))
            }
            ...
            a(v), x.addClass('spinner-is-loading'), t(x, !0), $.post(paper_s.url.account+"?token="+paper_s.token, {'input': w, 'value': r}, function(e) {
                if(e.S == 200) {
        ...
        paper_s.user_type != 'normal' && $('#btn-disconnect').click(function(){
            ...
            if(o){
                p = new FormData(), p.append('avatar', u.prop('files')[0]), t(r.text(paper_s.word.please_wait), !0), w.text(''), $.ajax({
            ...
            a ? (h.attr('src', s), u.val(''), o = !1, a = !1, r.text(paper_s.word.upload_a_picture), d.text(paper_s.word.delete), w.text(''), m == 0 && f(d)) : (t(d.text(paper_s.word.please_wait), !0), w.text(''), $.post(paper_s.url.reset_avatar+"?token="+paper_s.token, function(e){
            ...
            var y = $(this),
                ...
                k = j.children();
            v.text(''), t(y.addClass('spinner-is-loading'), !0), $.post(paper_s.url.send_code+"?token="+paper_s.token, function(e){
                (e.S == 200) ? f($(k[0]), l($(k[1])), n(y)) : (v.text(e.E), n(y))
            })
        })
    })()
})(paper_s);