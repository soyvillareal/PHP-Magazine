(function(){
    ...
    $('#show-symbols').click(function(){
        ...
        x.addClass('spinner-is-loading'), y(!0), $.post(paper_sc.url.change_password+"?token="+paper_sc.token, {'current-password': u.val(), 'password': v.val(), 're-password': h.val()}, function(e){
            (e.S == 200) ? window.location.href = paper_sc.url.r_login : ((e.EX == 1 ? (o.text(e.E), r(u)) : (s.text(e.E), r(v), r(h))), x.removeClass('spinner-is-loading'), y(!1));
        })
