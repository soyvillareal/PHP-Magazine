        ...
        (function(){
		    ...
		    w.find('.select_all').click(function(){
		        ...
		        if(u == 'newsletter-email'){
		            ...
		            g > 0 ? (i(z.addClass('active')), h.text(''), l(k, !1)) : z.removeClass('active'), (g > 400) ? (v.addClass('color-red').removeClass('color-green color-orange')) : ((g > 250) ? (v.addClass('color-orange').removeClass('color-red color-green')) : (v.addClass('color-green').removeClass('color-red color-orange'))), p.text(g), z.val(o.slice(0, 500))
		        } else if(u == 'reason'){
