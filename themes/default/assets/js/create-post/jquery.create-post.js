...
(function(){
	var f = function(e, u){
      ...
      b = function(e, u){
        ...
        if(w.find('.thumbnail_file').length > 0){
          w.find('.content-placeholder').addClass('hidden'), w.find('.content-image').removeClass('hidden'), w.find('.item_image').html('<img src="'+u+'" alt="'+paper_cp.word.preview+'"/>')
        } else {
    ...
    (function(){
      ...
      var o = $("#content-tags"),
          ...
          h = function(e) {
            var p = $('.item_tag'),
                w = r.val(),
                u = e ? e : w;
            if(u === '' || i.length >= paper_cp.settings.number_labels) return !1;
            d(p); 
      ...
      $('.tag_label').each(function(){
        ...
        l && (m.addClass('hidden'), r.val() != '' && $.post(paper_cp.url.get_tags+"?token="+paper_cp.token, {'search': r.val(), 'tags': JSON.stringify(i)}, function(e){
      ...
      var d = $('.btn_aentry'),
          ...
          o = function(e = '', i = !1){
            clearTimeout(I), $('#content-lnotify').css((paper_cp.dir == 'rtl' ? 'right' : 'left'), (i ? 20 : '')).find('p').text(e), I = setTimeout(function(){
              o()
            }, 5000);
          },
          c = function(e){
      ...
      (function(){
        ...
        x.click(function(){
          ...
          var p = a.val();
          p.length > 0 ? f(t, !1) : f(t, !0), $.post(paper_cp.url.ecu_search+'?token='+paper_cp.token, {keyword: p, user_ids: JSON.stringify(h)}, function(e){
            if(e.S == 200){
              d.html(e.HT)
            } else {
              d.html(e.HT ? e.HT : '')
          ...
          var n = $(this);
          f(n, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.push_user+'?token='+paper_cp.token, {push_id: n.attr('data-id'), user_ids: JSON.stringify(h)}, function(e){
            if(e.S == 200){
        ...
        $('#btn-acancel').click(m), $('#btn-delete').click(function(){
          ...
          l && (s(f(y, !0), u), f(n, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.get_image+"?token="+paper_cp.token, {'url': y.val()}, function(e){
                      if(e.S == 200){
        ...
        $('#btn-dnotify').click(o), x.click(function(){
          ...
          var p = a.val();
          p.length > 0 ?  f(t, !1) : f(t, !0), $.post(paper_cp.url.ecp_search+'?token='+paper_cp.token, {keyword: p, post_ids: JSON.stringify(h)}, function(e){
            if(e.S == 200){
              d.html(e.HT)
            } else {
              d.html(e.HT ? e.HT : '')
          ...
          s(l, p), f(n, !0).addClass('spinner-is-loading'), $(".text_simditor").each(function(i, e){
            m.push($(e).val());
          }), $.post(paper_cp.url.push_post+'?token='+paper_cp.token, {push_id: n.attr('data-id'), entry_text: JSON.stringify(m), post_ids: JSON.stringify(h)}, function(e){
            if(e.S == 200){
              x.before(e.HT).addClass('hidden'), h.push(e.ID), n.remove(), g(n);
            } else {
              e.PS == undefined ? (o(e.E, !0), g(f(n, !1))) : (l = $(l[e.PS]), $('html').animate({scrollTop: l.parents('.entry').position().top}, 750), p = l.siblings('.text-error'), o(paper_cp.word.oops_error_has_occurred, !0), k(l, p, e.E, f(n, !1)));
            }
          })
        ...
        var z = function(e, u){
            ...
            t = function(e){
              ...
              }), n ? (h.length > 0 && (y(p), p.find('.before').before('<span class="item_attrs margin-l5" data-pos="'+o+'">'+h+'</span>'), o++, p.find('.item_vattr').text(paper_cp.word.attribute).siblings('.item_vval').text(paper_cp.word.value), r.val('').removeClass('active').focus(), v.val('').removeClass('active'), d.append(q).removeClass('hidden'))) : k(r)
            },
            m = 0,
            o = 0;
        ...
        $(document).on('keyup, input', '.item_url', function(){
          ...
          var a = $(this),
              ...
              g = p.find('.btn_ifadd'),
              r = a.val(),
              q = paper_cp.word.attribute,
              h = paper_cp.word.value,
              v = r.length > 0 ? r : q;
        ...
        $(document).on('click', '.btn_esource', function(){
          ...
          var x = $(this),
              ...
              p = u.find("input"),
              v = w.find('.text-error');
          l && (s(f(p, !0), v), f(x, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.get_frame+"?token="+paper_cp.token, {'url': p.val(), 'type': w.attr('data-type')}, function(e){
                      if(e.S == 200){
                        a(w, u, e.HT), g(x)
                      } else {
                        k(f(p, !1), v, e.E, x)
          ...
          var x = $(this),
              ...
              v = w.find('.text-error');
            l && (s(f(p, !0), v), f(x, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.get_frame+"?token="+paper_cp.token, m(p.val(), w.attr('data-type')), function(e){
                        if(e.S == 200){
          ...
          l && (s(!1, u, w), f(w, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.entry+"?token="+paper_cp.token, {type: d.index(w)}, function(e){
                    if(e.S == 200) {
                      g(w), $('#entries').append(e.HT).find('.item_key:not(.no_focus)').focus(), e.TP == 'text' && j(!0), e.TP == 'video' && $('#type').val('video'), f($('.btn_post'), !0)
                    } else k(!1, u, e.E, w);
                  }))
        }), j()
      })();
