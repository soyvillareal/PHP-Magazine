(function(){
    ...
    (function(){
            ...
            if(e.S == 200){
              ...
              f(o, !1), n.attr('contenteditable', !0), $.isArray(e.E) ? $.each(e.E, function(e, u){
                var i = isNaN(u['el']),
                    ...
                    h = (!isNaN(u['content']) ? $(j[u['content']]).parent() : x).find('.text-error'),
                    a = $(j[u['content']]).children();
                k((i ? (u['shadow'] == 0 ? !1 : z) : x.find(u['class'])), h, u['text'], y, !1), u['el'] == '.post_sources' && u['pos'] && a.each(function(e, i){
                  if(u['pos'].indexOf(e) != -1) $(a[e]).find('input:nth-child('+u['field']+')').addClass('border-red')
                })
              }) : '', f(p, !1), l = !0
            }
          }
      ...
      $('#btn-acancel').click(m), $('#btn-delete').click(function(){
        ...
        !$(e.target).is('.btn_popup[aria-expanded=true], .btn_popup[aria-expanded=true] *, .btn_popup[aria-expanded=true] ~ .content-alert-popup, .btn_popup[aria-expanded=true] ~ .content-alert-popup *') && o(!0), e.target == t[0] && m()
      ...
      $(document).on('click', '.btn_esource', function(){
        ...
        l && (f(v, !1).val(''), w.find('.content-placeholder').removeClass('hidden'), w.find('.content-image').addClass('hidden'), w.find('.item_image img').remove(), v.val() != '' && f(u, !1).val(''), f(w.find('.btn_popup'), !1), q())
