(function(){
    ...
    (function(){
      ...
      var d = $('.btn_aentry'),
          ...
          o = function(e = '', i = !1){
            clearTimeout(I), $('#content-lnotify').css('left', (i ? 20 : '')).find('p').text(e), I = setTimeout(function(){
              o()
            }, 5000);
          },
          c = function(e){
      ...
      (function(){
        ...
        x.click(function(){
          ...
          f(n, !0).addClass('spinner-is-loading'), $.post(paper_cp.url.push_user+'?token='+paper_cp.token, {push_id: n.attr('data-id'), user_ids: JSON.stringify(h)}, function(e){
            if(e.S == 200){
              l.prepend(e.HT), h.push(e.ID), n.remove(), x.addClass('hidden'), g(n), l.sortable("refresh");
            } else {
              o(e.E, !0), g(f(n, !1));
            }
          })
