...
module.exports = function(socket, temp){
    return `<div class="content_pmtfile display-flex direction-row align-center margin-right-auto" data-id="{!fi_id}">
        ...
        <button class="btn_pmtmdelete w-30px h-30 btn-noway margin-r5 background-hover border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="file">
