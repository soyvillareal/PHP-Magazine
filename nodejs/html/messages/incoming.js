                ...
                <div class="item-pmtreply display-flex direction-row align-center position-relative margin-t15">
                    <div class="item-mavatar margin-top-auto margin-r5 overflow-hidden border-rall">
                        ...
                        temp.text != null ?
                            ...
                            <button class="btn_pmtmdelete w-30px h-30 btn-noway margin-r5 hover-background border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!id}" data-type="text">
