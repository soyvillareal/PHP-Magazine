...
module.exports = function(socket, temp){
    return `<div class="content_pmtimage display-flex direction-row align-center margin-b10" data-id="{!fi_id}">
        ...
        <button class="btn_pmtmdelete w-30px h-30 btn-noway margin-r5 hover-background border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="image">
