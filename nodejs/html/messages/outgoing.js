                ...
                <div class="display-flex direction-colum w-100 margin-r10">
                    ...
                    <div class="item-pmtreply display-flex direction-row align-center position-relative margin-t15 margin-l5">`+(
                        temp.text != null ?
                            ...
                            <button class="btn_pmtreply w-30px h-30 btn-noway margin-r5 background-hover color-grey border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!id}" data-type="text">
