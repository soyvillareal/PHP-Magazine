...
module.exports = function(socket, temp){
    return `<div class="content_pmtfile display-flex direction-row align-center margin-left-auto" data-id="{!fi_id}">
        <button class="btn_pmtdelete w-30px h-30 btn-noway margin-left-auto margin-r5 hover-background border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="file">
        ...
        <button class="btn_pmtreply w-30px h-30 btn-noway margin-l5 margin-r5 padding-5 hover-background color-grey border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="file">
        ...
        <a class="display-flex direction-row align-center background-grely position-relative margin-t5 border-r25px" href="{!fi_url}" target="_blank">
            ...
            <div class="display-flex direction-colum padding-t10 padding-b10 padding-l10 padding-r10">
                <span class="color-black break-all ellipsis-vertical ellipsis-v3">{!fi_name}</span>
                <span class="color-black font-low margin-t5">{!fi_size}</span>
            </div>
        </a>
    </div>`;  
};