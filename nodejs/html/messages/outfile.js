...
module.exports = function(socket, temp){
    return `<div class="content_pmtfile display-flex direction-row align-center margin-left-auto" data-id="{!fi_id}">
        <button class="btn_pmtdelete w-30px h-30 btn-noway margin-left-auto margin-r5 background-hover border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="file">
        ...
        <button class="btn_pmtreply w-30px h-30 btn-noway margin-l5 margin-r5 padding-5 background-hover color-grey border-rall opacity-0 hover-button animation-ease3s animate-tab-button" data-id="{!fi_id}" data-type="file">
